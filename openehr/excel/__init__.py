...
def append_df_to_excel(filename, df, sheet_name='Sheet1', startrow=None, startcol=None,
    ...
    *******************
    ...
    df.to_excel(writer, sheet_name, startrow=startrow, startcol=startcol, na_rep=na_rep, header=False,
                **to_excel_kwargs)
